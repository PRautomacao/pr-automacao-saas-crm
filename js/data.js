...
const DB = (() => {
  ...
  const SEED_EXAMES = [
    { id: 'EX001', codigo: 'HEM001', nome: 'Hemograma Completo',         tipo: 'Hematologia', convenio: 'Particular', valor: 25.00, status: 'ativo', observacoes: '' },
    { id: 'EX002', codigo: 'GLI001', nome: 'Glicemia em Jejum',          tipo: 'Bioquímica',  convenio: 'Particular', valor: 18.00, status: 'ativo', observacoes: '' },
    { id: 'EX003', codigo: 'COL001', nome: 'Colesterol Total + Frações', tipo: 'Bioquímica',  convenio: 'Particular', valor: 32.00, status: 'ativo', observacoes: '' },
    { id: 'EX004', codigo: 'TSH001', nome: 'TSH (Tireotropina)',          tipo: 'Hormônio',    convenio: 'Particular', valor: 45.00, status: 'ativo', observacoes: '' },
    { id: 'EX005', codigo: 'URI001', nome: 'Urina Tipo I (EAS)',          tipo: 'Urinálise',   convenio: 'Particular', valor: 22.00, status: 'ativo', observacoes: '' },
    { id: 'EX006', codigo: 'PSA001', nome: 'PSA Total e Livre',           tipo: 'Bioquímica',  convenio: 'Particular', valor: 55.00, status: 'ativo', observacoes: '' },
    { id: 'EX007', codigo: 'TGO001', nome: 'TGO / AST',                  tipo: 'Bioquímica',  convenio: 'Particular', valor: 20.00, status: 'ativo', observacoes: '' },
    { id: 'EX008', codigo: 'TGP001', nome: 'TGP / ALT',                  tipo: 'Bioquímica',  convenio: 'Particular', valor: 20.00, status: 'ativo', observacoes: '' },
    { id: 'EX009', codigo: 'FER001', nome: 'Ferritina',                  tipo: 'Hematologia', convenio: 'Particular', valor: 38.00, status: 'ativo', observacoes: '' },
    { id: 'EX010', codigo: 'VIT001', nome: 'Vitamina D (25-OH)',          tipo: 'Vitaminas',   convenio: 'Particular', valor: 68.00, status: 'ativo', observacoes: '' },
    { id: 'EX011', codigo: 'COA001', nome: 'Coagulograma (TP/TTPA)',      tipo: 'Coagulação',  convenio: 'Particular', valor: 35.00, status: 'ativo', observacoes: '' },
    { id: 'EX012', codigo: 'CRE001', nome: 'Creatinina',                 tipo: 'Bioquímica',  convenio: 'Particular', valor: 18.00, status: 'ativo', observacoes: '' }
  ];
